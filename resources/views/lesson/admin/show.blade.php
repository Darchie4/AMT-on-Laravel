    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-lg-7 vh-50">
                ...
                <div>
                    <h2>{{__('lesson.admin_show_title_practicalInformation')}}</h2>
...
__('pricing.'.$lesson->pricingStructure->payment_frequency).')'}}
                ...
                <div>
                    <h2 class="pt-3">{{__('lesson.admin_show_trainingTimes')}}</h2>
        ...
        <div class="col col-lg-5 vh-50">
            ...
            <div class="shadow-lg p-3 mb-5 bg-body rounded container">
                <h2 class="text-center">{{__('lesson.admin_show_teachers')}}</h2>
